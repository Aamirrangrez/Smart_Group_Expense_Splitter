...
export default function GroupsPage() {
  ...
  if (loading) return <div className="page-loader"><div className="spinner"></div> Loading groups...</div>;
    ...
    <div className="page-container">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">{groups.length} group{groups.length !== 1 ? 's' : ''} · split expenses together</p>
        </div>
